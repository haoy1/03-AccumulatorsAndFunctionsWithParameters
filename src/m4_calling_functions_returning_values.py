...
def run_test_sum_of_digits():
    ...
    # Test 2:
    expected = 10
    answer = sum_of_digits(145)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 4
    answer = sum_of_digits(400)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 14
    answer = sum_of_digits(428)
...
def digits_in_cube(n):
    ...
    """
    sum_of_digits_incube=sum_of_digits(n**3)
    return sum_of_digits_incube
    # ------------------------------------------------------------------
